   ...
   <nav class="navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar" id="nvbr">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <a class="navbar-brand" href="#"><img src="img/logoAD.png" alt="logo" id="log"></a>
        <!-- Left -->
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" id="men">Actualité</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#" id="men">Enseignements</a>
          </li>
          <li class="nav-item">
